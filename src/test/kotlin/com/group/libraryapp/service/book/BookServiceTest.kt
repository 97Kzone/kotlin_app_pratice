...
class BookServiceTest @Autowired constructor(
    ...
    fun loanBook() {
        ...
        val savedUser = userRepository.save(User("KDP", null))
        val request = BookLoanRequest("KDP", "이상한 나라의 엘리스")
    ...
    @Test
    @DisplayName("책이 진작 대출되어 있다면 신규대출 실패")
    fun loanBookFailTest() {
        ...
        assertThat(message).hasMessage("진작 대출되어 있는 책입니다")
    }
    ...
    fun returnBookTest() {
        ...
        val savedUser = userRepository.save(User("KDP", null))
        userLoanHistoryRepository.save(UserLoanHistory(savedUser, "이상한 나라의 엘리스", false))
        val request = BookReturnRequest("KDP", "이상한 나라의 엘리스")
